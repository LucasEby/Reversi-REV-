...
class CreateGameServerRequest(BaseServerRequest):
    ...
    def __init__(self, game: Game) -> None:
        ...
        if game.get_player2() is not None and isinstance(game.get_player2().get_user(), Account):
    ...
    # TODO: Define other getters for response values (game ID, opponent User object)
